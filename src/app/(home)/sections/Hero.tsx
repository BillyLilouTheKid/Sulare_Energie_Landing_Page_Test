    ...
    const TinyLink = ({text} : {text:string}) => {
        return (
            <div className="w-full flex flex-col text-white font-LTflodneue font-normal text-xs uppercase">
                <p className="font-LTflodneue font-normal tracking-wider my-1">{text}</p>
    ...
    return (
        <div id="accueil" className="w-screen h-screen bg-hero bg-cover bg-[center_40%] mb-8">
            ...
            <div className="w-full h-full flex flex-col justify-end px-16 z-10">
                <div className="grid grid-rows-1 grid-cols-2 mb-15 px-20">
                    <div className="flex flex-col items-start justify-end pr-2">
                        <p className="font-LTflodneue font-normal text-sm text-white tracking-widest">TITRE RÉFÉRENCEMENT</p>
                        <p className="font-LTflodneue font-light text-sm text-white/50 tracking-wide mt-8 mb-2 text-balance w-8/10">
                    ...
                    <div className="w-70 h-60 grid grid-cols-1 grid-rows-6 bg-gray-400/30 backdrop-blur-xs p-6 justify-self-end">
